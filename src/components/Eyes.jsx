...
function Eyes() {
  ...
  return (
    <div className='eyes w-full h-screen overflow-hidden'>
      <div data-scroll data-scroll-speed="-.6" className='w-full h-full bg-[url("https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-scaled.jpg")] bg-center bg-cover flex items-center justify-center'>
        <div data-scroll data-scroll-speed=".1" className=' flex gap-10'>
