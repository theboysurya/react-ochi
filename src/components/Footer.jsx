        ...
        <div className=' font-Test_Founders_Grotesk_X text-[9vw] uppercase leading-[6.5vw] text-[#212121]'>
            ...
            <div className='h-full flex items-center justify-between'>
                <div className='flex flex-col h-full justify-around'>
                    <div className='inline-flex text-left flex-col gap-4'>
                    ...
                    <div className='inline-flex text-left flex-col gap-4'>
                        <p className='inline'>L:</p>
                        <div className='inline-flex flex-col underline'>
                            <a href="#">202-1965 W 4th Ave
                            Vancouver, Canada</a>
                            <a href="#">30 Chukarina St
                            Lviv, Ukraine</a>
            ...
            <div className='flex justify-between text-[#9e9e9e] font-medium'>
                <p>ochi.design clone 2024.</p>
                <p>Website by @theboysurya</p>
            </div>
        </div>
    </div>
  )
